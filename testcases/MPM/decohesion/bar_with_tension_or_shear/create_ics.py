...
def create_ics(gridFilename, testType):
    ...
    for iCell in range(0, nCells):
        ...
        x = xCell[iCell]
        y = yCell[iCell]
        uAirVelocity[iCell] = signuLeft * airSpeed
        vAirVelocity[iCell] = signvLeft * airSpeed

        if (x > 120000):
           uAirVelocity[iCell] = signuRight * airSpeed
           vAirVelocity[iCell] = signvRight * airSpeed

    ...
    for icType in icTypes:
        ...
        for res in reses:
            ...
            if (not os.path.isfile(filenameOut)):
                ...
                # create velocity stress, and strain fields at material points
                # velocities
                ...
                for iParticle in range(0, nParticles):
                    ...
                    lam = 1.0
                    stressAnalyticalMP[iParticle, 0] = lam*strain11
                    stressAnalyticalMP[iParticle, 1] = lam*strain22
                    stressAnalyticalMP[iParticle, 2] = lam*strain12

                # append velocity, stress and strain to particle file

...
def get_norm_vertex(filenameIC, filename, latitudeLimit):
    ...
    strain11Avg = fileMPAS.variables["strain11AvgVertex"][0,:]
    strain22Avg = fileMPAS.variables["strain22AvgVertex"][0,:]
    strain12Avg = fileMPAS.variables["strain12AvgVertex"][0,:]

    normE11 = L2_norm_vertex(strain11Avg, strain11VertexAnalytical, nVertices, latVertex, areaTriangle, latitudeLimit)
    normE22 = L2_norm_vertex(strain22Avg, strain22VertexAnalytical, nVertices, latVertex, areaTriangle, latitudeLimit)
    normE12 = L2_norm_vertex(strain12Avg, strain12VertexAnalytical, nVertices, latVertex, areaTriangle, latitudeLimit)
...
def get_norm_particle(filenameIC, filename, latitudeLimit):
    ...
    normE11 = L2_norm_particle(strainMP[0,:,0], strainAnalyticalMP[:,0], nParticles, latLonParticle[0,:,0], latitudeLimit)
    normE22 = L2_norm_particle(strainMP[0,:,1], strainAnalyticalMP[:,1], nParticles, latLonParticle[0,:,0], latitudeLimit)
    normE12 = L2_norm_particle(strainMP[0,:,2], strainAnalyticalMP[:,2], nParticles, latLonParticle[0,:,0], latitudeLimit)

...
def get_norm_particle(filenameIC, filename, latitudeLimit):
    ...
    normU = L2_norm_particle(uvVelMP[0,:,0], uvVelAnalyticalMP[:,0], nParticles, latLonParticle[0,:,0], latitudeLimit)
    normV = L2_norm_particle(uvVelMP[0,:,1], uvVelAnalyticalMP[:,1], nParticles, latLonParticle[0,:,0], latitudeLimit)

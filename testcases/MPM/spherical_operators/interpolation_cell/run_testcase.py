...
from interpolation_cell_scaling import interpolation_cell_scaling
...
def run_testcase(logFilename=None):
    ...
    if (logFile is not None):
        ...
        log_message("  "+scriptDir+"/interpolation_cell_scaling.png", "magenta", logFile=logFile)
